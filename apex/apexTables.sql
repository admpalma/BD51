...
begin
    insert_tourist('Jose Mortagua', date '1987-05-13', '983763234', 'portugues(a)', 'portugues');
end;
/

begin
    insert_tourist('Jacques Francois', date '1978-01-30', '756283947', 'frances(a)', 'frances');
end;
/
insert into tourist_speaks(tourist_id, language) values (seq_tour_id.currval, 'alemao');

begin insert_tourist('Monica Wright', date '1995-09-10', '576039003', 'ingles(a)', 'frances'); end;
/
...
begin insert_tourist('Fei Wei Wei', date '1976-04-25', '352857337', 'chines(a)', 'ingles'); end;
/

insert into tourist_speaks(tourist_id, language) values (seq_tour_id.currval, 'chines');

begin insert_tourist('Park Jimin', date '1995-10-13', '462362718', 'coreano(a)', 'coreano'); end;
/

begin insert_tourist('Kim Taehyung', date '1995-12-30', '656646477', 'coreano(a)', 'coreano'); end;
/
insert into tourist_speaks(tourist_id, language) values (seq_tour_id.currval, 'japones');


begin insert_tourist('Vance Stevenson', date '1987-07-07', '222288882', 'americano(a)', 'ingles'); end;
/

begin insert_tourist('Vivian Ybarra', date '1977-09-15', '465823745', 'italiano(a)', 'italiano'); end;
/

begin insert_tourist('Leocadia Banderas', date '1968-02-19', '111888444', 'espanhol(a)', 'espanhol'); end;
/
insert into tourist_speaks(tourist_id, language) values (seq_tour_id.currval, 'italiano');

begin insert_tourist('Zac Baldwin', date '2001-08-29', '444888222', 'americano(a)', 'ingles'); end;
/

begin insert_tourist('Valerie Bourdoix', date '1998-03-19', '123987654', 'frances(a)', 'frances'); end;
/

begin insert_tourist('Artur Banderas', date '1962-11-12', '342764777', 'espanhol(a)', 'espanhol'); end;
/

begin insert_tourist('Sebastian Bourdoix', date '1992-02-01', '342634294', 'frances(a)', 'frances'); end;
/
insert into tourist_speaks(tourist_id, language) values (seq_tour_id.currval, 'ingles');

begin insert_tourist('Chrollo Lucilfer', date '1992-07-30', '666000666', 'ingles(a)', 'frances'); end;
/
insert into tourist_speaks(tourist_id, language) values (seq_tour_id.currval, 'ingles');
insert into tourist_speaks(tourist_id, language) values (seq_tour_id.currval, 'japones');

begin insert_tourist('Jeon Jungkook', date '1997-09-01', '111111111', 'coreano(a)', 'coreano'); end;
/
insert into tourist_speaks(tourist_id, language) values (seq_tour_id.currval, 'japones');


begin insert_tourist('Kim Seokjin', date '1992-12-04', '192129921', 'coreano(a)', 'coreano'); end;
/
insert into tourist_speaks(tourist_id, language) values (seq_tour_id.currval, 'japones');
insert into tourist_speaks(tourist_id, language) values (seq_tour_id.currval, 'ingles');

begin insert_tourist('Kim Namjoon', date '1994-09-12', '252525124', 'coreano(a)', 'coreano'); end;
/
insert into tourist_speaks(tourist_id, language) values (seq_tour_id.currval, 'japones');
insert into tourist_speaks(tourist_id, language) values (seq_tour_id.currval, 'ingles');
begin insert_tourist('Min Yoongi', date '1993-03-09', '666455545', 'coreano(a)', 'coreano'); end;
/
insert into tourist_speaks(tourist_id, language) values (seq_tour_id.currval, 'ingles');


begin insert_tourist('Jung Hoseok', date '1994-02-18', '666055545', 'coreano(a)', 'coreano'); end;
/
insert into tourist_speaks(tourist_id, language) values (seq_tour_id.currval, 'japones');
insert into tourist_speaks(tourist_id, language) values (seq_tour_id.currval, 'chines');

begin insert_tourist('Marcela Souza', date '1987-07-20', '616055005', 'portugues(a)', 'portugues'); end;
/

begin insert_tourist('Chica Silva', date '2003-08-21', '616033005', 'espanhol(a)', 'espanhol'); end;
/

begin insert_tourist('Alexandre Souza', date '1987-03-10', '616075005', 'portugues(a)', 'portugues'); end;
/

begin insert_tourist('Andre Santos', date '2001-04-30', '010000022', 'portugues(a)', 'portugues'); end;
/
insert into tourist_speaks(tourist_id, language) values (seq_tour_id.currval, 'ingles');
...
begin insert_museum(0.5, -20.5, 'Torre de Belem',
...
begin insert_museum(38.72079, -9.11705, 'Museu Nacional do Azulejo',
...
begin insert_hotel (40.67611, 7.70694, 'Casa da Insua', 'Perfeitamente integrado num Palacete Barroco do sec. XVIII, onde cada sala e cada recanto nos transportam para a historia dos seus proprietarios e para momentos da historia de Portugal e do Brasil, o Parador Casa da Insua conjuga passado e presente, com detalhes que fazem os seus visitantes sentir-se como parte dessa historia.',
...
begin insert_hotel (38.69491, -9.21472, 'Palacio do Governador',
...
begin insert_restaurant (38.69491, -9.21472, 'Restaurante e Bar Anfora',
...
begin insert_restaurant (40.69491, -7.21472, 'Restaurante Fake News I',
...
begin insert_restaurant (40.69491, -7.21472, 'Restaurante Fake News III',
